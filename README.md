# SnapSummary – AI Article Summarizer

SnapSummary is a modern web application that uses OpenAI's GPT-4 model to summarize articles. Simply paste an article URL, and SnapSummary will generate a concise summary for you.

## Features

Modern UI with a sleek dark mode design
