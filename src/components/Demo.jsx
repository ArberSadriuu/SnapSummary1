            ...
            <div className="relative mb-8">
                ...
                <div className="relative bg-gray-800 rounded-lg shadow-xl overflow-hidden">
                    ...
                    <div className="flex border-b border-gray-700">
                        ...
                        <button 
                            className={`flex-1 px-6 py-4 text-center font-medium transition-colors ${activeTab === "history" ? "text-accent border-b-2 border-accent bg-gray-800" : "text-gray-400 hover:text-gray-300 hover:bg-gray-700"}`}
                        ...
                        {activeTab === "summarize" && (
                            <div className='flex flex-col w-full gap-6'>
                                <div className="text-center mb-2">
                                    <h2 className="text-2xl font-bold text-blue-700 inline-block">
                                        Article Summarizer
                                    </h2>
                                    <p className="text-gray-400 mt-2">
                                        Paste any article URL and get a concise summary with SnapSummary
                                    </p>
                                </div>
                                ...
                                <form onSubmit={handleSubmit} className='w-full'>
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            required
                                            className="block w-full pl-10 pr-28 py-4 bg-gray-700 border border-gray-600 rounded-lg focus:ring-2 focus:ring-accent focus:border-accent text-white placeholder-gray-400"
                                            placeholder="Enter article URL"
                                        />
                                        <button
                                            type="submit"
                                            disabled={isLoading}
                                            className="absolute right-2.5 bottom-2.5 px-5 py-2 text-sm font-medium text-white bg-accent rounded-lg hover:bg-blue-600 focus:ring-4 focus:ring-blue-500/30 disabled:bg-gray-600 disabled:cursor-not-allowed transition-all"
                                        >
                                ...
                                {articles.length === 0 ? (
                                    <div className="text-center py-12 bg-gray-800/30 rounded-lg border border-gray-700">
                                        ...
                                        <button 
                                            ...
                                            className="px-4 py-2 text-sm font-medium text-white bg-accent rounded-md hover:bg-blue-600 focus:ring-4 focus:ring-blue-500/30 transition-all"
                                        >
                                            Try summarizing one
                                        </button>
                                    </div>
                                    ...
                                    <div className="space-y-4 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                                        {articles.map((item, index) => (
                                            <div 
                                                key={`link-${index}`}
                                                className={`bg-gray-800 border rounded-lg overflow-hidden transition-all ${item.url === currentArticle.url ? 'border-accent' : 'border-gray-700 hover:border-gray-500'}`}
                                            >
                                                ...
                                                {item.url === currentArticle.url && (
                                                    <div className="p-4 border-t border-gray-700">
                                                        ...
                                                        <button 
                                                            className="mt-2 text-xs text-accent hover:text-accent-dark flex items-center"
                                                            onClick={() => { 
